...
config :busi_api, BusiApiWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "UrV/4obPkQHrO6ijP8n/7QKG0ounFwSoGP/AFhWvKrUS2GkedGxJrwqeRGY8S74q",
  render_errors: [view: BusiApiWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: BusiApi.PubSub,
  live_view: [signing_salt: "qQgI+KW3"]
...
config :busi_api, BusiApiWeb.Auth.Guardian,
  issuer: "busi_api",
  secret_key: "jd/Q16G2pe0xKFj2meZR4fybayg9YArcSSi8Qd+lb8g6RrH5dnJFbZviu6bWzSx5"
